...
현재는 완성된 게임 서버가 아니며, 일부 패킷을 구현하여 **상업적 목적이 아닌 필드 구경과 추억 재현**을 목적으로 합니다.<br>
아직 버그가 다수 존재하며, 작동하지 않는 시스템이 많습니다.

## 소개

![스크린샷](./Raycity_20260523_1408_001.png)

v1.325는 게임 서비스 약 2달이 지난 시점의 클라이언트입니다.  
현재와는 다른 시스템이 많으며, 사양 최적화 패치(필드 텍스처 512x512 강제)가 적용되기 전 마지막 버전입니다.
